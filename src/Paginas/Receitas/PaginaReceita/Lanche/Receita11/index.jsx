...
import { LanchePagina } from '../../../ReceitasPaginas';
import PaginaReceitas from "../../../../../Componentes/ReceitaPagina";

export default function Receita11() {
  const idBuscado = 11; // ID desejado para a busca

  const receitaEncontrada = LanchePagina.find((receita) => receita.id === idBuscado);
